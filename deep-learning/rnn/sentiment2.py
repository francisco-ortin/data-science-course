...
test_loss, test_accuracy = compile_train_evaluate(one_directional_model, x_train, y_train, x_val, y_val, x_test, y_test,
                       32, 100, "data/one_directional_model.keras")
...
test_loss, test_accuracy = compile_train_evaluate(elmo_bi_lstm_model, x_train, y_train, x_val, y_val, x_test, y_test,
                       32, 100, "data/bi_directional_model.keras")
print(f"Test loss: {test_loss:.4f}.\nTest accuracy: {test_accuracy:.4f}.")
