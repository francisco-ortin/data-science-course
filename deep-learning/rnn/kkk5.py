...
# Load IMDb dataset
vocabulary_size = 20_000  # Number of most frequent words to consider
max_length = 200  # Maximum length of review (padded sequences)
...
embedding_dim = 50  # GloVe word vectors of 100 dimensions
...
embeddings_index = {}  # word -> vector(embedding_dim) mapping
...
print(f"Found {len(embeddings_index):,} word embeddings of {embedding_dim} dimensions.")
